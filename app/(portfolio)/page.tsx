  ...
  const content: Record<string, Content> = {
    en: {
      ...
      familyInfo: {
        ...
        content: `I met my wife, Zehra, in December 2015, and we married in September 2020. In February 2022, we welcomed our lovely son. 😊`,
      },
      languages: {
    ...
    tr: {
      ...
      resume: {
        title: "Özgeçmiş",
        content: `Anestezi asistanı ve geliştiriciyim. 1994 doğumluyum. 2013 yılında Atatürk Üniversitesi Tıp Fakültesi'ne başladım ve 2017'de Sakarya Üniversitesi'ne yatay geçiş yaptım, Ocak 2023'te mezun oldum. COVID-19 pandemisi sırasında (2020 Nisan civarı), TUS'a (Tıpta Uzmanlık Sınavı) çalışmayı bırakıp yazılıma yönelmeye karar verdim. İlk altı ayımda ilk amatör web sitem olan bir [dergi sistemini](https://github.com/drcan94/journalist) yaptım. Eşim Zehra ile Aralık 2015'te tanıştım ve Eylül 2020'de evlendik. Şubat 2022'de bir oğlumuz oldu.`,
      },
      academicCareer: {
        title: "Akademik Kariyer",
        content: `Uzatmalı akademik yolculuğumun ardından tıp eğitimimi tamamladım ve 1.5 yıl boyunca Konya'nın çeşitli hastanelerinde (Taşkent, Hadim, Bozkır, Beyhekim) ve Hatay/Samandağ'da pratisyen hekim olarak çalıştım. Bu süre zarfında devlet hizmet yükümlülüğümü de tamamladım. Mart 2024'te TUS'a girdim ve Necmettin Erbakan Üniversitesi Meram Tıp Fakültesi Anesteziyoloji ve Reanimasyon bölümünü kazandım. Eylül 2024'te başladığım bu yolculuğun henüz başındayım. Akredite bir klinikte, yetkin hocalarımızın ve kıdemlilerimizin gözetiminde uzmanlık eğitimi sürecim devam ediyor.`,
      },
      hobbies: {
        title: "Hobiler",
        content: `Satranç oynamayı, saatlerce kod yazmayı ve yeni teknolojileri keşfetmeyi seviyorum. Özellikle mesleğimi yaparken yazılımla işlerimi kolaylaştırmak veya bazen gerçekleşmese de çözümler hayal etmek çok heyecan verici.`,
      },
      projects: {
        title: "Projeler",
        content: [
          `[İntraoperatif Sıvı Takipçisi](/sivi): Ameliyat sırasında hasta sıvı hesaplamalarını otomatikleştirmek için Next.js ve Tailwind CSS kullanılarak oluşturulmuş bir sistem.`,
          `[Eğitim İçeriği Platformu](https://www.shopier.com/28216295): Yeni doktorlar için Shopier üzerinden erişilebilen, Notion ile oluşturulmuş eğitim içerikleri.`,
        ],
      },
      familyInfo: {
        title: "Aile Bilgileri",
        content: `Eşim Zehra ile Aralık 2015'te tanıştım ve Eylül 2020'de evlendik. Şubat 2022'de dünya tatlısı bir oğlumuz oldu. 😊`,
      },
      languages: {
        title: "Bilinen Diller",
        content: [
          `Yazılım Dilleri: Python (Django REST Framework), JavaScript (Next.js, TypeScript)`,
